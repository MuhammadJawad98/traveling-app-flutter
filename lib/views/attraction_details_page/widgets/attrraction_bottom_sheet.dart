        ...
        children: [
          ...
          Padding(
              ...
              child: Column(
                  ...
                  children: [
                    CustomText(
                        text: widget.databotomsheet.namelocation,
                        color: AppColors.talhablack,
                        size: GetScreenSize.getScreenWidth(context) * 0.05,
                        maxline: 1,
                        fontWeight: FontWeight.bold),
                    CustomText(
                        text: widget.databotomsheet.description,
                    ...
                    Row(
                        ...
                        children: [
                          MYRatingBar(
                              itemCount: 5,
                              itemPadding:
                                  GetScreenSize.getScreenWidth(context) * 0.005,
                              itemSize:
                                  GetScreenSize.getScreenWidth(context) * 0.05,
                              minRating: 1,
                              ratingValue: widget.ratingValue),
                          CustomText(
                              text: widget.databotomsheet.rating,
                              color: AppColors.talhablack,
                          ...
                          Expanded(
                              child: CustomText(
                                  text:
                                      '(${widget.databotomsheet.numberReviews})',
                                  color: AppColors.talhablack,
                                  size: GetScreenSize.getScreenWidth(context) *
                                      0.0356,
                                  maxline: 1,
                                  fontWeight: FontWeight.w400)),
                          CustomText(
                              text: AppString.attractionBSreview,
                              color: AppColors.talhagrey,
                              size: GetScreenSize.getScreenWidth(context) *
                                  0.0356,
                              maxline: 1,
                    ...
                    CustomText(
                        text: AppString.attractionBSpricing,
                        color: AppColors.talhablack,
                    ...
                    ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return AttractionBottomsheetListDesgin(
                              plandetail: planpricinglist[index]);
                        },
