      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(GetScreenSize.getScreenWidth(context) * 0.05, GetScreenSize.getScreenWidth(context) * 0.9, GetScreenSize.getScreenWidth(context) * 0.05, 0),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomText(text: widget.data.namelocation, color: AppColors.attractionScreenText, size: 42, maxline: 20, fontWeight: FontWeight.w500),
                  SizedBox(
                    height: GetScreenSize.getScreenWidth(context) * 0.01,
                  ),
                  CustomText(text: widget.data.description, color: AppColors.attractionScreenText, size: 14, maxline: 20, fontWeight: FontWeight.w500),
                  SizedBox(
